...
export const ClockIcon = ({ className }: IconProps) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
        ...
        <g id="SVGRepo_iconCarrier">
            <path fillRule="evenodd" clipRule="evenodd" d="M11.25 7.5L12.75 7.5L12.75 11.6893L15.5303 14.4697L14.4697 15.5303L11.25 12.3107L11.25 7.5Z" fill="currentColor">
            </path>
